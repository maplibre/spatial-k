...
class ExplodeTest {
    ...
    fun testExplodeFeatureCollection() {
        val featureCollection = buildFeatureCollection {
            addFeature { geometry = Point(Position(1.0, 2.0)) }
            addFeature { geometry = LineString(Position(3.0, 4.0), Position(5.0, 6.0)) }
            addFeature { geometry = MultiPoint(Position(7.0, 8.0), Position(9.0, 10.0)) }
        }
