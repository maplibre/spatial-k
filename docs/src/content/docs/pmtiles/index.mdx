...
supports uncompressed internal sections and stored tile payload bytes. Register compressors when
writing compressed internal sections or when asking the writer to compress uncompressed tile
payloads.
